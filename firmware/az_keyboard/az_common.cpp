...
void lv_setup() {
  ...
  // フォント http://www.fontna.com/blog/1226/
  // 変換　https://lvgl.io/tools/fontconverter
  // 参考　https://qiita.com/skyfish20ch/items/e5437221447b4307d299
  //-------------------------------------------------------------------
  /*Gum-like button*/
  ...
  // lv_obj_set_style_local_text_font(tab1, LV_DROPDOWN_PART_MAIN, LV_STATE_DEFAULT, &mfont30);
  // lv_obj_set_style_local_text_font(tab1, LV_DROPDOWN_PART_MAIN, LV_STATE_DEFAULT, &lv_font_montserrat_48);
  // lv_obj_set_style_local_text_font(btn1, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, &myf20);
  lv_obj_set_size(btn1, 200, 80);
  lv_obj_set_pos(btn1, 0, 0);
  // lv_bar_set_range(btn1, 0, 100);
  // lv_obj_align(    btn1, NULL, LV_ALIGN_CENTER, 0, 20);
  // lv_obj_add_style(btn1, LV_BTN_PART_MAIN, &style_gum);
  lv_obj_set_event_cb(btn1, event_handler);
  lv_obj_set_style_local_value_str(btn1, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, "ボタン１");
  // lv_obj_set_style_local_text_font(btn1, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, &myf20);
  
  lv_obj_t * btn2 = lv_btn_create(tab1, NULL);
  // lv_obj_add_style(btn2, LV_BTN_PART_MAIN, &style_gum);
  // lv_obj_set_style_local_line_color(btn2, LV_LINE_PART_MAIN, LV_STATE_DEFAULT, LV_COLOR_MAKE(0X19,0XFF,0X19));
  lv_obj_set_size(btn2, 200, 80);
  lv_obj_set_pos(btn2, 0, 100);
  lv_obj_set_drag(btn2, true);
  lv_obj_set_event_cb(btn2, event_handler);
  lv_obj_set_style_local_value_str(btn2, LV_BTN_PART_MAIN, LV_STATE_DEFAULT, "ぼたん２");
  
  label = lv_label_create(tab2, NULL);
  lv_label_set_text(label, "Second tab だよ");
  // lv_obj_set_style_local_text_font(label,LV_LABEL_PART_MAIN, LV_STATE_DEFAULT, &myf20);
